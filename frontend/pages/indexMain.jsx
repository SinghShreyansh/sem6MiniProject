                  ...
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Krishi allows you to identify dangerous crop diseases
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                Krishi allows you to identify dangerous crop diseases and apply
            ...
            <div className="w-96 md:w-5/12 px-4 mr-auto ml-auto mt-32">
              <Image src="https://res.cloudinary.com/sarveshp46/image/upload/v1674139681/farming-assistant/Phone-App-2-PUT_1_ynahxl.webp" width={1000} height={1000} />
            </div>
          </div>
